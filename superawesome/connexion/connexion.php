...
<body>
  ...
  <!-- Page Header -->
  <header class="masthead" style="background-image: url('../assets/img/inscription.jpg')">
      ...
      <div class="row">
        <div class="col-lg-10 col-md-10 mx-auto">
          <div class="page-heading">
            <h1>Connexion</h1>
            <span class="subheading">Entrez votre login et votre mot de passe</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-lg-8 col-md-10 mx-auto">
        <form action="../traitement/traitement.php" method="post">
          ...
          <br>
          <input type="submit" value="Connexion" class="btn btn-primary" name="submit" id="submit" />
        </form>
      </div>
    </div>
  </div>
  ...
  <script src="../assets/ClearB/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
